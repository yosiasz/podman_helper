...
input_file = "./data/syslogs/sample.log"
...
prompt = f"""
You are an assistant that categorizes and sorts syslog items.

Here is a list of syslog items:

{items}

Please:

1. Categorize these items into appropriate categories such as debug, error, failture, etc.
